        ...
        <div className="relative w-full overflow-hidden flex">
          ...
          <div className="flex gap-4 animate-marquee whitespace-nowrap py-1">
            {duplicatedPartners.map((item, idx) => (
              <div
                key={idx}
                className="inline-flex items-center gap-3 px-4 py-2.5 rounded-xl bg-white border border-slate-200/80 shadow-xs hover:border-slate-300 transition-colors"
              >

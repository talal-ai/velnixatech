...
export default function CaseStudiesSection({ onOpenConsultation }) {
  return (
    <section id="case-studies" className="py-24 sm:py-32 bg-white relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10">
          {CASE_STUDIES.map((study, idx) => (
            <div
              key={study.id}
              className="p-8 sm:p-10 lg:p-12 rounded-3xl bg-white border border-slate-200/90 shadow-soft-sm hover:shadow-soft-lg hover:border-brand-200 transition-all duration-300"
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                ...
                <div className="lg:col-span-7 space-y-6">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span className="text-xs text-slate-400">•</span>
                    <span className="text-xs font-semibold text-brand-600 bg-brand-50 px-2.5 py-0.5 rounded-md">
                      {study.serviceType}
                    </span>
                  </div>
                  ...
                  <div className="space-y-4 pt-2">
                    ...
                    <div className="p-4 rounded-2xl bg-brand-50/40 border border-brand-100">
                  ...
                  <div className="pt-2 border-t border-slate-100 flex items-start gap-3 text-slate-600">
                    <Quote className="w-5 h-5 text-brand-400 shrink-0 mt-1" />
                    <div>
                ...
                <div className="lg:col-span-5 flex flex-col justify-between p-6 sm:p-8 rounded-2xl bg-slate-900 text-white shadow-soft-md">
                  <div>
                    <div className="text-xs font-semibold uppercase tracking-wider text-brand-400 pb-3 mb-6 border-b border-slate-800">
